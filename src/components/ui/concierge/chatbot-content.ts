...
export const quickPrompts = [
  ...
  { label: "Explore Wellness", prompt: "What wellness experiences are available?" },
...
export function conciergeReply(message: string): string | null {
  return message.trim() ? "I can help with stays, wellness, dining, offers, membership, or booking." : null;
}
