...
export const diningDestinations: DiningDestination[] = [
  {
    ...
    description: "Precision, fire, and craftsmanship meet in an intimate dining experience in Seminyak.",
  ...
  },
  {
    ...
    location: "Ubud, Bali",
    eyebrow: "Open Fire",
    description: "A bold dining experience shaped by premium cuts, open flame, and modern craftsmanship.",
  ...
  },
  {
    ...
    description: "Mediterranean-inspired flavours, shared plates, and relaxed dining shaped for slow moments.",
    schedule: "New Opening — 2026",
  ...
  },
  {
    ...
    description: "A relaxed all-day dining destination pairing familiar flavours with a fresh tropical perspective.",
  ...
  },
  {
    ...
    description: "Japanese craft, tableside theatre, and live-fire cooking meet in an intimate Ubud setting.",
    schedule: "Dinner · 17:00 — 23:00",
  ...
  },
  {
    ...
    description: "A multi-sensory dinner where storytelling, projection, and refined courses unfold together.",
