export type JournalStoryLayout = "feature" | "standard" | "wide";
...
export const journalStories: JournalStory[] = [
  ...
  },
  {
    ...
    description:
      "Experience the spiritual heart of Bali through its temples, ceremonies, and living heritage.",
  ...
  },
  {
    ...
    description:
      "Warm days, fewer crowds, and vibrant landscapes—everything you need to know for the perfect September escape.",
    readingTime: "6 min read",
    image:
      "https://images.unsplash.com/photo-1476158085676-e67f57ed9ed7?auto=format&fit=crop&w=1600&q=85",
