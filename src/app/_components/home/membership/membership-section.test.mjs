...
const iconsSource = await readFile(new URL("./membership-benefit-icons.ts", import.meta.url), "utf8");
...
for (const icon of ["crown", "sparkles", "calendar-heart", "flower-2", "ticket-percent", "shield-check", "waves"]) {
